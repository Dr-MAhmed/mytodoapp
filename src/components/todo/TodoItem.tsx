...
export const TodoItem: React.FC<TodoItemProps> = ({
  ...
  return (
    <div
      ...
      style={style}
      className={cn(
        "group relative bg-card border rounded-xl p-4 shadow-sm hover:shadow-md transition-all duration-200",
    ...
    >
      <div className="flex items-start gap-3">
        ...
        <button
          {...attributes}
          {...listeners}
          className="mt-1 p-1 text-muted-foreground hover:text-foreground cursor-grab active:cursor-grabbing opacity-0 group-hover:opacity-100 transition-opacity"
        >
